...
spack:
  ...
  - compiler:
      spec: gcc@=14.2.0
      paths:
        cc: ${spack_pkg_install_path}/gcc/14.2.0/bin/gcc
        cxx: ${spack_pkg_install_path}/gcc/14.2.0/bin/g++
        f77: ${spack_pkg_install_path}/gcc/14.2.0/bin/gfortran
        fc: ${spack_pkg_install_path}/gcc/14.2.0/bin/gfortran
      flags: {}
  ...
  - compiler:
      spec: gcc@=13.3.0
      paths:
        cc: ${spack_pkg_install_path}/gcc/13.3.0/bin/gcc
        cxx: ${spack_pkg_install_path}/gcc/13.3.0/bin/g++
        f77: ${spack_pkg_install_path}/gcc/13.3.0/bin/gfortran
        fc: ${spack_pkg_install_path}/gcc/13.3.0/bin/gfortran
      flags: {}
      operating_system: ${os_version}
      target: x86_64
      modules: []
  ...
  - compiler:
      spec: gcc@=12.4.0
      paths:
        cc: ${spack_pkg_install_path}/gcc/12.4.0/bin/gcc
        cxx: ${spack_pkg_install_path}/gcc/12.4.0/bin/g++
        f77: ${spack_pkg_install_path}/gcc/12.4.0/bin/gfortran
        fc: ${spack_pkg_install_path}/gcc/12.4.0/bin/gfortran
      flags: {}
      operating_system: ${os_version}
      target: x86_64
      modules: []
  ...
  - compiler:
      spec: gcc@=11.5.0
      paths:
        cc: ${spack_pkg_install_path}/gcc/11.5.0/bin/gcc
        cxx: ${spack_pkg_install_path}/gcc/11.5.0/bin/g++
        f77: ${spack_pkg_install_path}/gcc/11.5.0/bin/gfortran
        fc: ${spack_pkg_install_path}/gcc/11.5.0/bin/gfortran
      flags: {}
      operating_system: ${os_version}
      target: x86_64
      modules: []
  ...
  - compiler:
      spec: nvhpc@=24.9
      paths:
        cc: ${spack_pkg_install_path}/nvhpc/24.9/Linux_x86_64/24.9/compilers/bin/nvc
        cxx: ${spack_pkg_install_path}/nvhpc/24.9/Linux_x86_64/24.9/compilers/bin/nvc++
        f77: ${spack_pkg_install_path}/nvhpc/24.9/Linux_x86_64/24.9/compilers/bin/nvfortran
        fc: ${spack_pkg_install_path}/nvhpc/24.9/Linux_x86_64/24.9/compilers/bin/nvfortran
      flags: {}
      operating_system: ${os_version}
      target: x86_64
      modules: []
  ...
  - compiler:
      ...
      paths:
        cc: ${spack_pkg_install_path}/intel-oneapi-compilers/2024.2.1/compiler/latest/bin/icx
        cxx: ${spack_pkg_install_path}/intel-oneapi-compilers/2024.2.1/compiler/latest/bin/icpx
        f77: ${spack_pkg_install_path}/intel-oneapi-compilers/2024.2.1/compiler/latest/bin/ifx
        fc: ${spack_pkg_install_path}/intel-oneapi-compilers/2024.2.1/compiler/latest/bin/ifx
      flags:
        cflags: -lpthread
        cxxflags: -lpthread
      operating_system: ${os_version}
  ...
  - compiler:
      ...
      paths:
        cc: ${spack_pkg_install_path}/intel-oneapi-compilers/2025.0.0/compiler/latest/bin/icx
        cxx: ${spack_pkg_install_path}/intel-oneapi-compilers/2025.0.0/compiler/latest/bin/icpx
        f77: ${spack_pkg_install_path}/intel-oneapi-compilers/2025.0.0/compiler/latest/bin/ifx
        fc: ${spack_pkg_install_path}/intel-oneapi-compilers/2025.0.0/compiler/latest/bin/ifx
      flags:
        cflags: -lpthread
        cxxflags: -lpthread
      operating_system: ${os_version}
...
#      externals:
#      - spec: mpt@=2.30
#        prefix: /software/mpi/mpt-2.30
#    slurm:
#      buildable: False
#      externals:
#      - spec: slurm@=23.02.7
#        prefix: /software/slurm/23.02.7
EOF
...
OPENMPIS=('openmpi')
INTELMPIS=()
GCCS=('gcc@=10.5.0' 'gcc@=11.5.0' 'gcc@=12.4.0' 'gcc@=13.3.0')
ONEAPIS=('oneapi@=2024.2.1' 'oneapi@=2025.0.0')
INTELS=('intel@=2021.10.0')
NVHPCS=() #'nvhpc@=24.9')
MPTS=() #'mpt@=2.30')

unset MPIS COMPS SPKGS PPKGS
MPIS=("\${MPICHS[@]}" "\${OPENMPIS[@]}" "\${INTELMPIS[@]}") # "\${MPTS[@]}")
...
EOF
comp_spkg_ppkg_loop
SPKGS=('boost') # boost & nvhpc aren't happy in v0.22.1
COMPS=("${GCCS[@]}" "${ONEAPIS[@]}" "${INTELS[@]}")
comp_spkg_loop
...
# [Rocky8-Testbed-hpc-libs]$ spack uninstall --all --dependents %gcc@11.5.0
# [Rocky8-Testbed-hpc-libs]$ spack uninstall --all --dependents %gcc@13.3.0
